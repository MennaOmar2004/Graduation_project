...
class BehavioralTasks extends StatefulWidget {
  ...
  @override
  State<BehavioralTasks> createState() => _TasksScreenState();
}

class _TasksScreenState extends State<BehavioralTasks> {
            ...
            children: [
              ...
              BlocBuilder<TasksCubit,TasksState>(builder: (BuildContext context, state) {
                if(state is TasksLoaded){
                  ...
                  final dailyTasks =
                  cubit.getDailyTasks("مهام سلوكية");

                  final personalTasks =
                  cubit.getPersonalTasks("مهام سلوكية");
                  return Expanded(
                    child: Column(
                      children: [
                        Padding(
