...
/// Centralized application color tokens
class AppColors {
  // Primary Text Color
  ...
  static const Color bgSurface = Color(0xFFF5F7FF);
  ...
  static const List<Color> primaryGradient = [Color(0xFF5479FC), Color(0xFF7B9BFF)];
  static const List<Color> secondaryGradient = [Color(0xFF52C49D), Color(0xFF3DB88B)];
  static const List<Color> accentGradient = [Color(0xFFFF6EB4), Color(0xFFD9527A)];
  static const List<Color> micListeningGradient = [Colors.redAccent, Color(0xFFFF6B6B)];
}
